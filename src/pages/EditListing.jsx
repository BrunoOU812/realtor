          ...
          <div className="flex space-x-6 mb-6">
            <div className="">
              ...
              <input
                ...
                onChange={onChange}
                required
                className="w-full px-4 py-2 text-xl border border-gray-300 bg-white rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600"
                min="-90"
                max="90"
              />
            </div>
